...
**Out of scope for MVP:** authentication, editing jobs, search/filtering, pagination, email notifications, styling polish. (Deleting jobs is in scope.)
...
- [x] A job can be deleted from `/` after a confirmation prompt, and is immediately removed from the list.
...
- `docs/changes/2026-07-21-delete-job-post.md` — add job deletion
- `docs/changes/2026-07-20-add-github-actions-test-pipeline.md` — CI runs tests on PR
- `docs/changes/2026-07-19-add-application-url-property.md` — add `ApplicationUrl` to `Job`
- `docs/changes/2026-07-19-rename-job-properties.md` — rename `JobType`/`Remote` properties to `EmploymentType`/`LocationType`
